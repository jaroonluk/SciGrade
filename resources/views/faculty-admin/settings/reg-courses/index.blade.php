...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="form-section rounded-xl p-6">
        ...
        <p class="text-xs text-[#7A4A3A]/70 mt-3">
            ...
            (รายวิชา SC ที่สร้างในปีปฏิทินที่ตรงกับปีการศึกษา − 543)
            แล้วเพิ่มเฉพาะรหัสที่ยังไม่มีใน <span class="font-medium">scigraddb.pdcourse</span>
            เพื่อให้อาจารย์เลือกชื่อวิชาตอนรายงานผลการสอบ
        </p>
    </div>
